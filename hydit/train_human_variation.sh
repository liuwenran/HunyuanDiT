task_flag="human_img_variation_pexels114_cliph_noproj_3"                                # the task flag is used to identify folders.
...
sh $(dirname "$0")/run_g_human_variation.sh \
    ...
    --img-variation-resume-path /mnt/petrelfs/liuwenran/forks/HunyuanDiT/log_EXP/195-human_img_variation_pexels114_cliph_noproj_2/checkpoints/0026000.pt/mp_rank_00_model_states.pt \
